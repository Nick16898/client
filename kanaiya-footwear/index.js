...
function initHeroSneakerStage() {
  ...
  const colorways = {
    stealth: {
      src: '../assets/kanaiya-footwear/hero_sneaker_black.jpg',
    ...
    orange: {
      src: '../assets/kanaiya-footwear/hero_sneaker_orange.jpg',
...
function initBagDrawer() {
  ...
  document.querySelectorAll('.card-btn-cart').forEach(btn => {
    btn.addEventListener('click', (e) => {
      ...
      const img = card.querySelector('.card-media-box img')?.src || '../assets/kanaiya-footwear/hero_sneaker_black.jpg';
